...
func (r *ServiceAccountReconciler) Reconcile(ctx context.Context, minio *v1alpha1.Minio) (ctrl.Result, error) {
	currentSpec, err := r.getServiceAccount(ctx, minio)
	if err != nil {
		return ctrl.Result{}, err
	}

	desiredSpec, err := r.getDesiredServiceAccountSpec(minio)
	if err != nil {
		return ctrl.Result{}, err
	}
...
func (r *ServiceAccountReconciler) getServiceAccount(ctx context.Context, minio *v1alpha1.Minio) (*corev1.ServiceAccount, error) {
	var serviceAccount corev1.ServiceAccount
	if err := r.GetClient().Get(ctx, client.ObjectKeyFromObject(minio), &serviceAccount); err != nil {
		return nil, client.IgnoreNotFound(err)
	}
	return &serviceAccount, nil
}

func (r *ServiceAccountReconciler) getDesiredServiceAccountSpec(minio *v1alpha1.Minio) (*corev1.ServiceAccount, error) {
